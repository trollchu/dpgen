...
            for single_sys in os.listdir(os.path.join(init_data_prefix, ii)):
                print(single_sys)
                init_data.append(dpdata.LabeledSystem(os.path.join(init_data_prefix, ii, single_sys), fmt='deepmd/npy'))
        else:
